...
# parser.add_argument("--same_folder", default='final_Fivek', type=str)
# parser.add_argument("--input_folder", default='tmp/FiveK_C/test', type=str)
parser.add_argument("--same_folder", default='final_lol', type=str)
...
if __name__ == '__main__':
    ...
    dataset = create_webdataset(args.input_folder)
    ...
    for batch in dataloader:
        ...
        ref_path = batch["ref_path"] 
    
        save_name = os.path.basename(input_path[0])  
        ...
        if os.path.exists(save_path):
            ...
            continue
        input_path = os.path.join(args.input_folder, input_path[0])
        ref_path = os.path.join(args.input_folder, ref_path[0])
